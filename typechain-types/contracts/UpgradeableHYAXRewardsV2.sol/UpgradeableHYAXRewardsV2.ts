...
export interface UpgradeableHYAXRewardsV2 extends BaseContract {
  connect(runner?: ContractRunner | null): UpgradeableHYAXRewardsV2;
  waitForDeployment(): Promise<this>;

  interface: UpgradeableHYAXRewardsV2Interface;
