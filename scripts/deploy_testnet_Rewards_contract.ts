...
async function main() {
    ...
    txSmartContractDeployment.maxPriorityFeePerGas = ethers.parseUnits("28", "gwei"); // Set the maximum priority fee per gas
    txSmartContractDeployment.maxFeePerGas = ethers.parseUnits("28", "gwei"); // Set the maximum fee per gas
